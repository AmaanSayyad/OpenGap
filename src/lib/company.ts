...
export const GTM = [
  "Judges: live tape at opengap.xyz, public agent, this mint graduated to PumpSwap.",
  "Distribution: @Open_Gap, Telegram, Discord, and the deepest green name on the tape.",
